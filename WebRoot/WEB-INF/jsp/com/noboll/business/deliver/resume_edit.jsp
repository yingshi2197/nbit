		...
		<div class="tab-form1">
			<form action="business/resume/edit.do" id="myform"
				...
				<div class="form-group">
					...
					<div class="col-xs-4 form-control-1">
						<select class="form-control select required" dictCode="education" name="education"  dictValue="<c:out value="${resume.education}" />">
						</select>
					</div>
					
					<label for="work_life" class="col-xs-2 control-label">工作年限</label>
					<div class="col-xs-4 form-control-1">
						<select class="form-control select required" dictCode="work_life" name="workLife"  dictValue="<c:out value="${resume.workLife}" />">
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-4 form-control-1">
						<input type="text" class="form-control email" name="email"
							id="email"
							placeholder="请输入邮箱"
							value="<c:out value="${resume.email}" />" maxlength="100"/>
					</div>
					
					<label for="address" class="col-xs-2 control-label">地址</label>
					<div class="col-xs-4 form-control-1">
						<select class="form-control select required" dictCode="address" name="address"  dictValue="<c:out value="${resume.address}" />">
						</select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<label for="status" class="col-xs-2 control-label">简历状态</label>
					<div class="col-xs-4 form-control-1">
						<select class="form-control select required" dictCode="resume_status" name="status"  dictValue="<c:out value="${resume.status}" />">
						</select>
					</div>
				</div>
