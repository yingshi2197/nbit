...
<html lang="zh-CN">
  ...
  <body>
	  <div class="container">
	  	<div class="tab-form1">
	  		<form action="business/dict/add.do" id="myform" class="form-horizontal" role="form" method="post">
	          ...
	          <div class="form-group" style="margin-top: 10px">
			   ...
			   <div class="form-group">
			      ...
			      <input  id="chooseId" name="typeId" type="hidden"  value="<c:out value="${type.id}" />"  />
			     <div class="col-xs-10 form-control-1">
			      <input type="text" class="form-control required" name="demoChoose" id="chooseValue" 
			        placeholder="请选择类型"
			         readonly="readonly"  value="<c:out value="${type.name}" />">
			         <c:if test="type==null">
			   ...
			   <div class="form-group">
			    ...
			    <div class="form-group">
			      ...
			      <input type="text"  class="form-control  required number" name="seq" id="seq" 
			         placeholder="请输入序列"
			          value="<c:out value="${seq}" />" maxlength="40"/>
			      </div>
			   </div>
			  <div class="form-group">
