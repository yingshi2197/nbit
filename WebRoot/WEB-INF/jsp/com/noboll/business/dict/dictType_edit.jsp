...
<html lang="zh-CN">
  <head>
    ...
    <title><spring:message code="com.noboll.business.common.edit"/></title>
  ...
  <body>
	  <div class="container">
	 	 <div class="tab-form1" >
	  		<form action="business/dictType/edit.do" id="myform" class="form-horizontal" role="form" method="post">
	          <input type="hidden"  name="id"  value="<c:out value="${dictType.id}" />" />
	          <div class="form-group" style="margin-top: 10px">
			      <label for="name" class="col-xs-2 control-label text-right">名称</label><!-- 名称 -->
			      <div class="col-xs-10 form-control-1">
				      <input type="text" class="form-control required" name="name" id="name" 
				         placeholder="请输入名称"
				         value="<c:out value="${dictType.name}" />" maxlength="200"/>
			      </div>
			   </div>
			   <div class="form-group">
			      ...
			      <div class="col-xs-10 form-control-1">
				      <input type="text" class="form-control required english" name="code" id="code" 
				         placeholder="请输入编码"
				          value="<c:out value="${dictType.code}" />" maxlength="40"/>
			      </div>
			   </div>
			   <div class="form-group">
			      ...
			      <textarea class="form-control" name="description" id="description" 
			         placeholder="请输入描述"><c:out value="${dictType.description}" /></textarea>
			      </div>
			   </div>
