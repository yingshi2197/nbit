		...
		<div class="tab-form1">
			<form id="myform"
				...
				<div class="form-group">
					<label for="REvaluateStar" class="col-sm-2 control-label">总分：</label>
					<div class="col-sm-9 form-control-1">
						<input id="REvaluateStar"
							name="REvaluateStar" type="number" class="rating" min=0 max=5
							step=1 data-size="xs" readonly="readonly" value="<c:out value="${evaluate.REvaluateStar}" />"/>
					</div>
				</div>
				
				<!-- 评价 -->
				<div class="form-group" style="margin-top: 20px;">
					<label for="REvaluate" class="col-sm-2 control-label">评价：</label>
					<div class="col-sm-9 form-control-1">
