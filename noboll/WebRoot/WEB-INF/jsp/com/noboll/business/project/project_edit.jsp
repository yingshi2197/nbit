...
<body>
	<div class="container">
		<div class="tab-form1">
			<form action="business/project/edit.do" id="myform"
				...
				<div class="form-group">
					...
					<div class="col-xs-4 form-control-1">
						<input type="text" class="form-control required" name="container"
							id="container" 	placeholder="请输入容器路径"	 value="<c:out value="${project.container}" />" maxlength="400" />
					</div>
					
					<label for="port" class="col-xs-2 control-label">端口地址</label>
					<div class="col-xs-4 form-control-1">
						<input type="text" class="form-control digits" name="port"
							id="port" 	placeholder="请输入端口地址"	 value="<c:out value="${project.port}" />" maxlength="10" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-xs-4 form-control-1">
						<input type="radio"  id="formal_1" name="formal" value="1"  <c:if test="${project.formal==1}"> checked="checked"   </c:if>  class="required"  />
                        	<label for="formal_1">是</label>
                        <input type="radio"  id="formal_0" name="formal" value="0"  <c:if test="${project.formal==0}"> checked="checked"   </c:if> class="required"  />
