...
<html lang="zh-CN">
  ...
  <body>
	  <div class="container">
	  	<div class="tab-form1">
	  		<form action="business/position/edit.do" id="myform" class="form-horizontal" role="form" method="post">
			  ...
			  <div class="form-group">
			      ...
			      <input  id="chooseId" name="type" type="hidden"  value="<c:out value="${position.type}" />"  />
			      <div class="col-xs-10 form-control-1">
			      	<input type="text" class="form-control required" name="demoChoose" id="chooseValue" 
			         readonly="readonly"  value="<c:out value="${position.typeName}" />">
			      </div>
			   </div>
			  <div class="form-group">
