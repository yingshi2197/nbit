...
<html lang="zh-CN">
  <head>
	...
	<meta http-equiv="keywords" content="数据字典类型">
	<meta http-equiv="description" content="数据字典类型">
    		...
    		$(document).ready(function () {
		       	$("#table-javascript").initBootTable({
	                ...
	                rowButtons:[ // select 表示选择规则，1表示多选，0表示单选，空表示不选
	                	{name:'新增',position:'top',select:"",css:"add",dialog:{url:"business/dictType/toAdd.do",width:"450px"}},//新增
	                	{name:'修改',position:'row',css:"edit",a:'',dialog:{url:"business/dictType/toEdit.do",width:"450px"}},//修改	         	
	                	{name:'删除',position:'row',css:"remove",type:"ajax",url:"business/dictType/remove.do"},//删除
	                	{name:'子项列表',position:'row',css:"edit",a:'',dialog:{url:"business/dict/toList.do?typeId={id}",height:"550px",width:"800px"}}//子项列表	         	
	                ],
	                clickToSelect: true,
	                columns: [
