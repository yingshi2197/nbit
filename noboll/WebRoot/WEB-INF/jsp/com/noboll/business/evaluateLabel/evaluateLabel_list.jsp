  ...
  <body>
  	<div class="container">
	  		 <div class="table-responsive">
				<div class="panel-heading-choose">评价标签列表</div>
    	...
    	<script type="text/javascript">
    		...
    		$(document).ready(function () {
		       	$("#table-javascript").initBootTable({
		       		method: 'post',
		       		searchDiv:"searchDiv",
	                url: 'business/evaluateLabel/list.do',
	                addUrl:"",
	                striped: true,
	                pagination: true,
	                ...
	                rowButtons:[ // select 表示选择规则，1表示多选，0表示单选，空表示不选
	                	{name:'新增',position:'top',select:"",css:"add",dialog:{url:"business/evaluateLabel/toAdd.do",width:"500px"}},//新增
	                	{name:'修改',position:'row',css:"edit",a:'',dialog:{url:"business/evaluateLabel/toEdit.do",width:"500px"}},//修改	         	
	                	{name:'删除',position:'row',css:"remove",type:"ajax",url:"business/evaluateLabel/remove.do"}//删除
	                ],
	                clickToSelect: true,
	                columns: [
				                    ...
				                    {field: 'score',index:'score',title: '分值',align: 'left',valign: 'top'},	//分值
